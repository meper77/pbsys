...
$text['bm'] = [
    ...
    'save' => 'Simpan',
    'cancel' => 'Batal',
    'contractor_name_placeholder' => 'Isi nama kontraktor',
    'phone_placeholder' => 'Isi nombor telefon kontraktor',
    'contractor_id_placeholder' => 'Isi nombor kontraktor',
    ...
    'registration_success' => 'Kenderaan kontraktor berjaya didaftar!',
...
// English
$text['en'] = [
    'page_title' => 'Add Contractor Vehicle',
    'system_name' => 'NEO V-TRACK - Vehicle Management & Monitoring System',
    'admin_role' => 'Administrator',
    'logout' => 'Log Out',
    'logout_confirm' => 'Are you sure you want to log out?',
    'add_contractor_vehicle' => 'Add Contractor Vehicle',
    'back_to_list' => 'Back to List',
    'contractor_name' => 'Contractor Name',
    'phone' => 'Phone Number',
    'contractor_id' => 'Contractor Number',
    ...
    'save' => 'Save',
    'cancel' => 'Cancel',
    'contractor_name_placeholder' => 'Enter contractor name',
    'phone_placeholder' => 'Enter contractor phone number',
    'contractor_id_placeholder' => 'Enter contractor number',
    ...
    'registration_success' => 'Contractor vehicle registered successfully!',
...
if (isset($_POST['submit'])) {
    ...
    if (count($error) < 1) {
        ...
        if ($result) {
            ...
            header('location:contractorcar.php');
            exit();
        } else {
            $output .= "<div class='alert alert-danger alert-dismissible fade show' role='alert'>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="contractorcar.php">
...
<div class="main-content">
    <div class="form-container">
        <div class="form-title">
            <h3><i class="fas fa-user-plus"></i> <?php echo $t['add_contractor_vehicle']; ?></h3>
            <a href="contractorcar.php" class="btn-cancel">
        ...
        <form method="POST" id="contractorVehicleForm">
            <input type="hidden" id="status" name="status" value="Kontraktor">
            
            <div class="mb-4">
                <label for="name" class="form-label">
                    <i class="fas fa-user me-2"></i><?php echo $t['contractor_name']; ?>
                </label>
                <input type="text" id="name" name="name" 
                       placeholder="<?php echo $t['contractor_name_placeholder']; ?>" 
            ...
            <div class="mb-4">
                <label for="idnumber" class="form-label">
                    <i class="fas fa-id-card me-2"></i><?php echo $t['contractor_id']; ?>
                </label>
                <input type="text" id="idnumber" name="idnumber" 
                       placeholder="<?php echo $t['contractor_id_placeholder']; ?>" 
...
$(document).ready(function() {
    ...
    // Contractor Number validation (4-5 digits only)
    ...
    // Form validation
    $('#contractorVehicleForm').on('submit', function() {
        let valid = true;
        ...
        // Validate contractor number format (4-5 digits)
        var contractorNumber = $('#idnumber').val().replace(/\D/g, '');
        if (contractorNumber) {
            if (contractorNumber.length < 4 || contractorNumber.length > 5) {
                $('#idnumber').addClass('is-invalid');
                alert('<?php echo $lang == "bm" ? "Nombor kontraktor mesti mengandungi 4-5 digit." : "Contractor number must contain 4-5 digits."; ?>');
                valid = false;
            }
            
            // Check if it's all digits (already enforced by input handler)
            if (!/^\d+$/.test(contractorNumber)) {
                $('#idnumber').addClass('is-invalid');
                alert('<?php echo $lang == "bm" ? "Nombor kontraktor hanya boleh mengandungi nombor." : "Contractor number can only contain numbers."; ?>');
                valid = false;
            }
        }
