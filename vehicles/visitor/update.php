...
$text['bm'] = [
    ...
    'van' => 'VAN',
    'mpv' => 'MPV',
    'name_placeholder' => 'Isi nama pelawat',
    'phone_placeholder' => 'Isi nombor telefon pelawat',
    'ic_placeholder' => 'Isi nombor IC pelawat',
...
// English
$text['en'] = [
    'page_title' => 'Update Visitor Vehicle',
    'system_name' => 'NEO V-TRACK - Vehicle Management & Monitoring System',
    'status' => 'Status',
    'name' => 'Name',
    'phone' => 'Phone Number',
    'ic_number' => 'Visitor IC Number',
    ...
    'save' => 'Save',
    'back' => 'Back',
    'update_success' => 'Visitor vehicle updated successfully!',
    ...
    'van' => 'VAN',
    'mpv' => 'MPV',
    'name_placeholder' => 'Enter visitor name',
    'phone_placeholder' => 'Enter visitor phone number',
    'ic_placeholder' => 'Enter visitor IC number',
...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        echo "<script>alert('{$t['update_success']}'); window.location.href='/vehicles/visitor/list.php';</script>";
        exit();
    } else {
...
if ($id > 0) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<script>alert('Rekod kenderaan tidak ditemui!'); window.location.href='/vehicles/visitor/list.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('ID Kenderaan tidak sah!'); window.location.href='/vehicles/visitor/list.php';</script>";
    exit();
}
?>
...
<div class="main-content">
    <div class="form-card">
        ...
        <form method="POST">
            ...
            <div class="mb-4">
                <label for="idnumber" class="form-label"><?php echo $t['ic_number']; ?>:</label>
                <input type="text" id="idnumber" name="idnumber" class="form-control" placeholder="<?php echo $t['ic_placeholder']; ?>" value="<?php echo htmlspecialchars($vehicle_data['idnumber'] ?? ''); ?>" required>
            </div>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="/vehicles/visitor/list.php" class="btn btn-danger">
...
$(document).ready(function() {
    ...
    // IC number validation (alphanumeric, uppercase)
