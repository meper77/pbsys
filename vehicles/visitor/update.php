...
if ($id > 0) {
    ...
    else { echo "<script>alert('Rekod tidak ditemui.'); window.location.href='/vehicles/visitor/list.php';</script>"; exit; }
} else { echo "<script>alert('ID tidak sah.'); window.location.href='/vehicles/visitor/list.php';</script>"; exit; }
