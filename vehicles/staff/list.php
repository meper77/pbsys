...
// Fetch records
$rows = [];
$result = mysqli_query($con, "SELECT * FROM `owner` WHERE status = 'Staf' ORDER BY id DESC");
if ($result) {
...
<main class="page">
    <div class="page-head">
        ...
        <div class="actions">
            <a class="btn btn-primary" href="/vehicles/staff/add.php"><i data-lucide="plus"></i> <?php echo htmlspecialchars($t['add']); ?></a>
        </div>
    </div>
