...
<div class="main-content">
    <div class="content-container">
        <div class="content-title">
            ...
            <a href="/vehicles/staff/add.php" class="add-btn">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="/vehicles/staff/update.php?id=<?php echo $id; ?>" class="edit-btn">
                                    <i class="fas fa-edit me-1"></i><?php echo $t['edit']; ?>
                                </a>
                                <a href="/vehicles/staff/delete.php?id=<?php echo $id; ?>" class="delete-btn" onclick="return confirm('<?php echo $lang == 'bm' ? 'Adakah anda pasti ingin memadam rekod ini?' : 'Are you sure you want to delete this record?'; ?>')">
        ...
        <div class="no-data">
            ...
            <a href="/vehicles/staff/add.php" class="btn btn-primary mt-3">
                <i class="fas fa-plus-circle me-2"></i><?php echo $t['add_staff_vehicle']; ?>
            </a>
        </div>
        <?php endif; ?>
