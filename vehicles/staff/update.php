...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `owner` SET name='$staffname', phone='$phone', idnumber='$staffno', type='$type', status='$status', platenum='$staffplate', stickerno='$stickerno', sticker='$sticker' WHERE id=$id";
