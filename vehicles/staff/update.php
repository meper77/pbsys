...
// Bahasa Malaysia
$text['bm'] = [
    'page_title' => 'Kemaskini Kenderaan Staf',
...
// English
$text['en'] = [
    'page_title' => 'Update Staff Vehicle',
    ...
    'save' => 'Save',
    'back' => 'Back',
    'update_success' => 'Staff vehicle updated successfully!',
...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        echo "<script>alert('{$t['update_success']}'); window.location.href='/vehicles/staff/list.php';</script>";
        exit();
    } else {
...
if ($id > 0) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<script>alert('Rekod kenderaan tidak ditemui!'); window.location.href='/vehicles/staff/list.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('ID Kenderaan tidak sah!'); window.location.href='/vehicles/staff/list.php';</script>";
    exit();
}
?>
...
<head>
    ...
    <style>
        ...
        .status-staff { background-color: #667eea; color: white; }
        .status-student { background-color: #f5576c; color: white; }
        .status-visitor { background-color: #4facfe; color: white; }
        .status-contractor { background-color: #43e97b; color: white; }
    ...
    <div class="form-card">
        ...
        <form method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" class="form-control" value="<?php echo htmlspecialchars($vehicle_data['name'] ?? ''); ?>" required>
            </div>
            
            <div class="mb-4">
                <label for="phone" class="form-label"><?php echo $t['phone']; ?>:</label>
                <input type="text" id="phone" name="phone" class="form-control" value="<?php echo htmlspecialchars($vehicle_data['phone'] ?? ''); ?>" required>
            </div>
            
            <div class="mb-4">
                <label for="idnumber" class="form-label"><?php echo $t['staff_no']; ?>:</label>
                <input type="text" id="idnumber" name="idnumber" class="form-control" value="<?php echo htmlspecialchars($vehicle_data['idnumber'] ?? ''); ?>" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="platenum" name="platenum" class="form-control" value="<?php echo htmlspecialchars($vehicle_data['platenum'] ?? ''); ?>" required>
            </div>
                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" id="stickerno" name="stickerno" class="form-control" 
                               ...
                               placeholder="<?php echo $lang == 'bm' ? 'Masukkan No. Stiker' : 'Enter Sticker Number'; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="/vehicles/staff/list.php" class="btn btn-danger">
