            ...
            ?>
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a class="btn btn-quiet" href="/vehicles/contractor/delete.php?id=<?php echo $id; ?>" title="Delete" onclick="return confirm('<?php echo addslashes($t['delete_confirm']); ?>')"><i data-lucide="trash-2"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
