...
$t = ($lang === 'bm') ? [
    'eyebrow' => 'PESARA', 'title' => 'Daftar kenderaan', 'sub' => 'Tambah rekod kenderaan pesara (alumni) baharu.',
    ...
    'idnum' => 'No. KP', 'idnum_ph' => 'cth. 600101-01-1234', 'phone' => 'No. Telefon', 'phone_ph' => 'cth. 012-3456789',
    'date' => 'Tarikh ambil pelekat', 'note' => 'Catatan', 'note_ph' => 'Catatan (pilihan)',
    'serial' => 'No. Siri Pelekat', 'serial_hint' => 'Biar kosong untuk auto (set semula setiap tahun).',
    'select_type' => 'Sila pilih', 'save' => 'Simpan', 'cancel' => 'Batal',
    'plate_exists' => 'Nombor plat sudah wujud untuk pemilik lain.', 'success' => 'Kenderaan pesara berjaya didaftar.',
    'required' => 'Sila isi nombor plat dan telefon.',
] : [
    'eyebrow' => 'ALUMNI', 'title' => 'Register vehicle', 'sub' => 'Add a new alumni vehicle record.',
    ...
    'idnum' => 'IC number', 'idnum_ph' => 'e.g. 600101-01-1234', 'phone' => 'Phone', 'phone_ph' => 'e.g. 012-3456789',
    'date' => 'Sticker issue date', 'note' => 'Note', 'note_ph' => 'Note (optional)',
    'serial' => 'Sticker serial no.', 'serial_hint' => 'Leave blank to auto-assign (resets each year).',
    'select_type' => 'Please select', 'save' => 'Save', 'cancel' => 'Cancel',
    'plate_exists' => 'Plate number already belongs to another owner.', 'success' => 'Alumni vehicle registered successfully.',
...
if (isset($_POST['submit'])) {
    $result = nv_vehicle_register($con, 'Pesara', $error);
    if ($result !== false) {
        $_SESSION['success_message'] = $t['success'];
        header('location:/vehicles/alumni/list.php'); exit;
...
<main class="page">
    <div class="page-head">
        ...
        <div class="actions">
            <a class="btn btn-ghost" href="/vehicles/alumni/list.php"><i data-lucide="arrow-left"></i> <?php echo htmlspecialchars($t['cancel']); ?></a>
        </div>
    </div>
    <form class="card nv-stack gap-6" method="post" id="vehicleForm">
        ...
        <input type="hidden" name="status" value="Pesara">
        ...
        <div class="nv-row end gap-2">
            <a class="btn btn-ghost" href="/vehicles/alumni/list.php"><?php echo htmlspecialchars($t['cancel']); ?></a>
