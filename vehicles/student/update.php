...
nv_guard_page($con, 'student');   // admins, or users granted this category, may manage
...
$text = [];
$text['bm'] = [
    'eyebrow' => 'Pelajar', 'page_title' => 'Kemaskini kenderaan', 'sub' => 'Kemaskini maklumat kenderaan pelajar.',
    'status' => 'Status', 'name' => 'Nama', 'phone' => 'No. telefon', 'ic_number' => 'No. matrik',
    ...
    'name_placeholder' => 'Nama pelajar', 'phone_placeholder' => 'cth. 012-3456789',
    'ic_placeholder' => 'cth. 2023123456', 'plate_placeholder' => 'cth. WPN 4421',
];
$text['en'] = [
    'eyebrow' => 'Student', 'page_title' => 'Update vehicle', 'sub' => 'Update student vehicle details.',
    'status' => 'Status', 'name' => 'Name', 'phone' => 'Phone', 'ic_number' => 'Matric number',
    'vehicle_type' => 'Vehicle type', 'plate_number' => 'Plate number',
    'save' => 'Save', 'cancel' => 'Cancel',
    'update_success' => 'Student vehicle updated.',
    'update_failed' => 'Failed to update student vehicle',
    'name_placeholder' => 'Student name', 'phone_placeholder' => 'e.g. 012-3456789',
...
if ($id > 0) {
    ...
    else { echo "<script>alert('Rekod tidak ditemui.'); window.location.href='/vehicles/student/list.php';</script>"; exit(); }
} else { echo "<script>alert('ID tidak sah.'); window.location.href='/vehicles/student/list.php';</script>"; exit(); }
        ...
        <div class="nv-grid cols-2">
            <div class="field"><label class="field-label" for="status"><?= htmlspecialchars($t['status']) ?></label>
                <select class="select" id="status" name="status" required>
                    <?php foreach (['Pelajar','Staf','Pelawat','Kontraktor'] as $opt): ?>
