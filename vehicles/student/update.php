...
$text['bm'] = [
    ...
    'save' => 'Simpan',
    'back' => 'Kembali',
    'update_success' => 'Kenderaan pelajar berjaya dikemaskini!',
    'update_failed' => 'Gagal mengemaskini kenderaan pelajar',
    'logout' => 'Log Keluar',
    ...
    'van' => 'VAN',
    'mpv' => 'MPV',
    'name_placeholder' => 'Isi nama pelajar',
    'phone_placeholder' => 'Isi nombor telefon pelajar',
    'matric_placeholder' => 'Isi nombor matrik pelajar',
...
// English
$text['en'] = [
    'page_title' => 'Update Student Vehicle',
    ...
    'save' => 'Save',
    'back' => 'Back',
    'update_success' => 'Student vehicle updated successfully!',
    'update_failed' => 'Failed to update student vehicle',
    'logout' => 'Log Out',
    ...
    'phone_placeholder' => 'Enter student phone number',
    'matric_placeholder' => 'Enter student matric number',
...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        echo "<script>alert('{$t['update_success']}'); window.location.href='/vehicles/student/list.php';</script>";
        exit();
    } else {
...
if ($id > 0) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<script>alert('Rekod kenderaan tidak ditemui!'); window.location.href='/vehicles/student/list.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('ID Kenderaan tidak sah!'); window.location.href='/vehicles/student/list.php';</script>";
    exit();
}
?>
...
<head>
    ...
    <style>
        ...
        .status-staff { 
            background-color: #667eea; /* Blue - matches carian kenderaan */
            color: white; 
        }
        .status-student { 
            background-color: #f093fb; /* Purple - matches carian kenderaan */
            color: white; 
        }
        .status-visitor { 
            background-color: #43e97b; /* Green - matches carian kenderaan */
            color: white; 
        }
        .status-contractor { 
            background-color: #ff9966; /* Orange - matches carian kenderaan */
            color: white; 
        }
        ...
        .sticker-ada { background-color: #28a745; color: white; }
        .sticker-tiada { background-color: #dc3545; color: white; }
...
<div class="main-content">
    <div class="form-card">
        ...
        <form method="POST">
            ...
            <div class="mb-4">
                <label for="idnumber" class="form-label"><?php echo $t['matric_no']; ?>:</label>
                <input type="text" id="idnumber" name="idnumber" class="form-control" placeholder="<?php echo $t['matric_placeholder']; ?>" value="<?php echo htmlspecialchars($vehicle_data['idnumber'] ?? ''); ?>" required>
            </div>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="/vehicles/student/list.php" class="btn btn-danger">
...
$(document).ready(function() {
    ...
    // Matric number validation (alphanumeric, uppercase)
