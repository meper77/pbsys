...
// Bahasa Malaysia
$text['bm'] = [
    'page_title' => 'Pengurusan Kenderaan Pelajar',
    'system_name' => 'NEO V-TRACK - Sistem Pengurusan & Pemantauan Kenderaan',
    'admin_role' => 'Administrator',
    'logout' => 'Log Keluar',
    'logout_confirm' => 'Adakah anda pasti ingin log keluar?',
    'student_vehicles_list' => 'Senarai Kenderaan Pelajar',
    'add_student_vehicle' => 'Tambah Kenderaan Pelajar',
    'student_id' => 'No. Matriks',
...
// English
$text['en'] = [
    'page_title' => 'Student Vehicle Management',
    'system_name' => 'NEO V-TRACK - Vehicle Management & Monitoring System',
    'admin_role' => 'Administrator',
    'logout' => 'Log Out',
    'logout_confirm' => 'Are you sure you want to log out?',
    'student_vehicles_list' => 'Student Vehicles List',
    'add_student_vehicle' => 'Add Student Vehicle',
...
// Get student vehicles data
$student_vehicles = [];
$no = 1;
$sql = "SELECT * FROM `owner` WHERE status = 'Pelajar'";
$result = mysqli_query($con, $sql);

if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        $student_vehicles[] = $row;
    }
}
?>
    ...
    <div class="container">
        <div class="logo-container">
            ...
            <div class="system-title">
                <h1><i class="fas fa-user-graduate"></i> <?php echo $t['page_title']; ?></h1>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/vehicles/student/list.php">
...
<div class="main-content">
    <div class="content-container">
        <div class="content-title">
            <span><i class="fas fa-list-alt me-2"></i><?php echo $t['student_vehicles_list']; ?></span>
            <a href="/vehicles/student/add.php" class="add-btn">
                <i class="fas fa-plus-circle me-2"></i><?php echo $t['add_student_vehicle']; ?>
            </a>
        </div>
        ...
        <?php if (count($student_vehicles) > 0): ?>
        <div class="table-responsive">
            <table class="data-table table-striped" id="studentTable">
                <thead>
                    <tr>
                        <th width="50"><?php echo $t['no']; ?></th>
                        <th width="120"><?php echo $t['student_id']; ?></th>
                ...
                <tbody>
                    <?php 
                    $counter = 1;
                    foreach ($student_vehicles as $row): 
                        $id = $row['id'];
                        $studentid = htmlspecialchars($row['idnumber']);
                        $studentname = htmlspecialchars($row['name']);
                        $phone = htmlspecialchars($row['phone']);
                        $studentplate = htmlspecialchars($row['platenum']);
                    ...
                    <tr>
                        ...
                        <td><strong><?php echo $studentname; ?></strong></td>
                        <td><?php echo $phone; ?></td>
                        <td><span class="vehicle-number"><?php echo $studentplate; ?></span></td>
                        <td><?php echo $type; ?></td>
                        <td>
                            <?php 
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="/vehicles/student/update.php?id=<?php echo $id; ?>" class="edit-btn">
                                    <i class="fas fa-edit me-1"></i><?php echo $t['edit']; ?>
                                </a>
                                <a href="/vehicles/student/delete.php?id=<?php echo $id; ?>" class="delete-btn" onclick="return confirm('<?php echo $lang == 'bm' ? 'Adakah anda pasti ingin memadam rekod ini?' : 'Are you sure you want to delete this record?'; ?>')">
        ...
        <div class="no-data">
            ...
            <h4><?php echo $lang == 'bm' ? 'Tiada Kenderaan Pelajar' : 'No Student Vehicles'; ?></h4>
            <p><?php echo $lang == 'bm' ? 'Tiada rekod kenderaan pelajar dijumpai.' : 'No student vehicle records found.'; ?></p>
            <a href="/vehicles/student/add.php" class="btn btn-primary mt-3">
                <i class="fas fa-plus-circle me-2"></i><?php echo $t['add_student_vehicle']; ?>
            </a>
        </div>
        <?php endif; ?>
...
$(document).ready(function() {
    ...
    $('#export-btn').on('click', function() {
        ...
        if (table.length) {
            ...
            var wb = XLSX.utils.table_to_book(tableClone[0], {sheet: "Student Vehicles"});
            XLSX.writeFile(wb, "student-vehicles-<?php echo date('Y-m-d'); ?>.xlsx");
        }
    });
});
</script>
