...
<main class="page">
    <div class="page-head">
        <div>
            <span class="eyebrow">Pelajar</span>
            <h1>Vehicle record</h1>
        </div>
        <div class="actions">
            <a class="btn btn-ghost" href="/vehicles/student/list.php"><i data-lucide="arrow-left"></i> Back</a>
            <?php if ($row): ?><a class="btn btn-primary" href="/vehicles/student/update.php?id=<?= (int)$row['id'] ?>"><i data-lucide="pencil"></i> Edit</a><?php endif; ?>
        </div>
    </div>
    <?php if ($row): ?>
