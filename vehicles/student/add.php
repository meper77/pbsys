...
$t = ($lang === 'bm') ? [
    ...
    'sub'     => 'Tambah rekod kenderaan baharu untuk pelajar UiTM.',
    'name'    => 'Nama pelajar',
    'name_ph' => 'Isi nama pelajar',
    'phone'   => 'No. telefon',
    'phone_ph'=> 'Isi nombor telefon pelajar',
    'idnum'   => 'No. Matrik',
    'idnum_ph'=> 'Isi nombor matrik',
    'type'    => 'Jenis kenderaan',
    'plate'   => 'No. plat kenderaan',
    'plate_ph'=> 'Isi nombor plat',
    'stickerno'=> 'No. Stiker',
    'stickerno_ph'=> 'Masukkan no. stiker',
    ...
    'sub'     => 'Add a new vehicle record for UiTM students.',
    'name'    => 'Owner name',
    'name_ph' => 'Enter student name',
    'phone'   => 'Phone number',
    'phone_ph'=> 'Enter phone number',
    'idnum'   => 'Matric no.',
    'idnum_ph'=> 'Enter matric number',
    'type'    => 'Vehicle type',
    'plate'   => 'Plate number',
    'plate_ph'=> 'Enter plate number',
    'stickerno'=> 'Sticker no.',
    'stickerno_ph'=> 'Enter sticker number',
...
<main class="page">
    <div class="page-head">
        ...
        <div class="actions">
            <a class="btn btn-ghost" href="/vehicles/student/list.php"><i data-lucide="arrow-left"></i> <?php echo htmlspecialchars($t['cancel']); ?></a>
        </div>
    </div>
    ...
    <form class="card nv-stack gap-6" method="post" id="vehicleForm">
        ...
        <div class="nv-row end gap-2">
            <a class="btn btn-ghost" href="/vehicles/student/list.php"><?php echo htmlspecialchars($t['cancel']); ?></a>
