...
// Bahasa Malaysia
$text['bm'] = [
    'page_title' => 'Tambah Kenderaan Pelajar',
    ...
    'save' => 'Simpan',
    'cancel' => 'Batal',
    'student_name_placeholder' => 'Isi nama pelajar',
    'phone_placeholder' => 'Isi nombor telefon pelajar',
    'student_id_placeholder' => 'Isi nombor matrik pelajar',
    ...
    'registration_success' => 'Kenderaan pelajar berjaya didaftar!',
...
// English
$text['en'] = [
    'page_title' => 'Add Student Vehicle',
    ...
    'student_id_placeholder' => 'Enter student ID number',
    ...
    'registration_success' => 'Student vehicle registered successfully!',
...
if (isset($_POST['submit'])) {
    ...
    if (count($error) < 1) {
        $sql = "INSERT INTO `owner` (`name`, `phone`, `idnumber`, `type`, `status`, `platenum`, `stickerno`, `sticker`)
                VALUES('$name','$phone','$matric','$type','$status','$platenum','$stickerno','$sticker')";
...
<head>
    ...
    <style>
        ...
        /* Black Navbar - UPDATED for better visibility */
        .navbar-black {
        ...
        /* UPDATED: More visible active state */
...
<div class="main-content">
    <div class="form-container">
        <div class="form-title">
            <h3><i class="fas fa-user-plus"></i> <?php echo $t['add_student_vehicle']; ?></h3>
            <a href="/vehicles/student/list.php" class="btn-cancel">
        ...
        <form method="POST" id="studentVehicleForm">
            <input type="hidden" id="status" name="status" value="Pelajar">
            
            <div class="mb-4">
                <label for="name" class="form-label">
                    <i class="fas fa-user me-2"></i><?php echo $t['student_name']; ?>
                </label>
                <input type="text" id="name" name="name" 
                       placeholder="<?php echo $t['student_name_placeholder']; ?>" 
            ...
            <div class="mb-4">
                <label for="idnumber" class="form-label">
                    <i class="fas fa-id-card me-2"></i><?php echo $t['student_id']; ?>
                </label>
                <input type="text" id="idnumber" name="idnumber" 
                       placeholder="<?php echo $t['student_id_placeholder']; ?>" 
                       class="form-control" required>
            </div>
...
$(document).ready(function() {
    ...
    // Student ID validation (assuming it's alphanumeric)
    $('#idnumber').on('input', function() {
        this.value = this.value.toUpperCase();
    });
    
    // Form validation
    $('#studentVehicleForm').on('submit', function() {
        let valid = true;
