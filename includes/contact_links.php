...
function format_contact_links($phone) {
    ...
    $btn = 'display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:50%;color:#fff;text-decoration:none;font-size:13px;';
    // Keep call + WhatsApp together on one row (nowrap flex group) so a narrow
    // cell never splits the two icons across lines.
    return
        '<span style="display:inline-flex;gap:4px;vertical-align:middle;white-space:nowrap;">'
