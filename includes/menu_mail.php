	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav menus">
				...
				<li class="nav-item"><a class="nav-link" href="emailform.php" id="email_menu">Hantar Mail</a></li>
				<!--li class="nav-item"><a class="nav-link" href="/includes/email_staff.php" id="emailstaf_menu">Mail Staf</a></li>
				<li class="nav-item"><a class="nav-link" href="/admin/print.php" id="print_menu">Cetak</a></li-->
			</ul>
		</div>
