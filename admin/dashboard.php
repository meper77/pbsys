...
<div class="main-content">
    <div class="content-container">
        <div class="content-title">
            ...
            <a href="/admin/add_admin.php" class="add-btn">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="/admin/update_admin.php?id=<?php echo htmlspecialchars($id_value); ?>" class="edit-btn">
                                    <i class="fas fa-edit me-1"></i><?php echo $t['edit']; ?>
                                </a>
                                <a href="/admin/delete_admin.php?id=<?php echo htmlspecialchars($id_value); ?>" class="delete-btn" onclick="return confirm('<?php echo $lang == 'bm' ? 'Adakah anda pasti ingin memadam admin ini?' : 'Are you sure you want to delete this admin?'; ?>')">
        ...
        <div class="no-data">
            ...
            <a href="/admin/add_admin.php" class="btn btn-primary mt-3">
                <i class="fas fa-plus-circle me-2"></i><?php echo $t['add_admin']; ?>
            </a>
        </div>
        <?php endif; ?>
