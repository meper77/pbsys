...
if (!$admin) {
    header('Location: /admin/dashboard.php'); // Redirect regular admins
    exit();
}
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="sidebar">
                    ...
                    <a href="/admin/dashboard.php" class="nav-link"><i class="fas fa-chart-line me-2"></i><?php echo $t['nav_dashboard']; ?></a>
                    <a href="/vehicles/staff/list.php" class="nav-link"><i class="fas fa-car me-2"></i><?php echo $t['nav_staff']; ?></a>
                    <a href="/vehicles/student/list.php" class="nav-link"><i class="fas fa-car me-2"></i><?php echo $t['nav_student']; ?></a>
                    <a href="/vehicles/visitor/list.php" class="nav-link"><i class="fas fa-car me-2"></i><?php echo $t['nav_visitor']; ?></a>
                    <a href="/vehicles/contractor/list.php" class="nav-link"><i class="fas fa-car me-2"></i><?php echo $t['nav_contractor']; ?></a>
                    <a href="/admin/users.php" class="nav-link"><i class="fas fa-users me-2"></i><?php echo $t['nav_user_mgmt']; ?></a>
                    <a href="/admin/dashboard.php" class="nav-link"><i class="fas fa-user-tie me-2"></i><?php echo $t['nav_admin']; ?></a>
                    <a href="/admin/superadmin.php" class="nav-link active"><i class="fas fa-crown me-2"></i><?php echo $t['nav_superadmin']; ?></a>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="add-admin" role="tabpanel">
                                <form id="addAdminForm" method="POST" action="/api/admin_management_api.php">
                            ...
                            <div class="tab-pane fade" id="add-user" role="tabpanel">
                                <form id="addUserForm" method="POST" action="/api/admin_management_api.php">
