...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        echo "<script>alert('{$t['update_success']}'); window.location.href='studentcar.php';</script>";
        exit();
    } else {
...
if ($id > 0) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<script>alert('Rekod kenderaan tidak ditemui!'); window.location.href='studentcar.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('ID Kenderaan tidak sah!'); window.location.href='studentcar.php';</script>";
    exit();
}
?>
    ...
    <div class="form-card">
        ...
        <form method="POST">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="studentcar.php" class="btn btn-danger">
