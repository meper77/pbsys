                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="updateUser.php?id=<?php echo $id; ?>" class="edit-btn">
                                    <i class="fas fa-edit me-1"></i><?php echo $t['edit']; ?>
                                </a>
                                <a href="deleteUser.php?id=<?php echo $id; ?>" class="delete-btn" onclick="return confirm('<?php echo $lang == 'bm' ? 'Adakah anda pasti ingin memadam pengguna ini?' : 'Are you sure you want to delete this user?'; ?>')">
