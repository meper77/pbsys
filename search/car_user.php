...
<div class="dashboard">
    <div class="back-button-container">
        <a href="/admin/index_user.php" class="back-btn">
...
<div class="search-container">
    ...
    <div class="quick-filters">
        ...
        <a href="/search/car_user.php?status=Staf<?php echo $lang != 'bm' ? '&lang=en' : ''; ?>" class="filter-btn <?php echo ($status == 'Staf') ? 'active' : ''; ?>"><?php echo $t['filterStaff']; ?></a>
        <a href="/search/car_user.php?status=Pelajar<?php echo $lang != 'bm' ? '&lang=en' : ''; ?>" class="filter-btn <?php echo ($status == 'Pelajar') ? 'active' : ''; ?>"><?php echo $t['filterStudent']; ?></a>
        <a href="/search/car_user.php?status=Pelawat<?php echo $lang != 'bm' ? '&lang=en' : ''; ?>" class="filter-btn <?php echo ($status == 'Pelawat') ? 'active' : ''; ?>"><?php echo $t['filterVisitor']; ?></a>
        <a href="/search/car_user.php?status=Kontraktor<?php echo $lang != 'bm' ? '&lang=en' : ''; ?>" class="filter-btn <?php echo ($status == 'Kontraktor') ? 'active' : ''; ?>"><?php echo $t['filterContractor']; ?></a>
        <a href="/search/car_user.php?showAll=true<?php echo $lang != 'bm' ? '&lang=en' : ''; ?>" class="filter-btn <?php echo $showAll ? 'active' : ''; ?>"><?php echo $t['filterAll']; ?></a>
    </div>
</div>
...
<div class="results-section">
    ...
    <div class="text-end mt-4">
        ...
        <a href="/search/car_user.php<?php echo $lang != 'bm' ? '?lang=en' : ''; ?>" class="btn btn-purple ms-2">
    ...
    <div class="no-results">
        ...
        <a href="/search/car_user.php<?php echo $lang != 'bm' ? '?lang=en' : ''; ?>" class="btn btn-purple mt-3">
