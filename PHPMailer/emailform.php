...
{
 $path = 'upload/' . $_FILES["attachment"]["name"]; //All file attachment that have to be sent must be in this folder
				...
				<div class="card-header">
					<div class="row">
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-6">
							<h3 class="card-title">Sistem Mel</h3>
						</div>
						<body>
							<form method="post" action="emailform.php" enctype="multipart/form-data">
							
							<H5 style="color: black;">Nama : </H5>
							<input type="text" id="name" name="name" class="form-control mb-2" value="" required readonly>
							
							<H5 style="color: black;">No. Matrik/Staf : </H5>
							<input type="text" id="idnumber" name="idnumber" value="" class="form-control mb-2" required readonly>
							
							<H5 style="color: black;">Emel Pelajar/Staf : </H5>
							<input type="text" id="email" name="email" class="form-control mb-2" required readonly>
							
							<H5 style="color: black;">No. Plate Kenderaan : </H5>
							<input type="text" id="platenum" name="platenum" placeholder="Isi no. kenderaan" onkeyup="GetDetail(this.value)" value="" class="form-control mb-2" required>
							
							<H5 style="color: black;">Jenis Kesalahan : </H5>
							<select type="text" id="subject" name="subject" value="kesalahan" class="form-control mb-2" required>
							<option selected hidden>Pilih Jenis Kesalahan</option>
							...
							<option value="Meletakkan kenderaan di tempat khas atau yang tidak dibenarkan">Meletakkan kenderaan di tempat khas atau yang tidak dibenarkan</option>
							</select>
							...
							<H5 style="color: black;">Lampiran emel : </H5>
...
<script>
        function GetDetail(str) {
            if (str.length == 0) {
                ...
                xmlhttp.open("GET", "../autofill.php?platenum=" + str, true);
                xmlhttp.send();
            }
        }
</script>
