...
// Bahasa Malaysia
$text['bm'] = [
    'page_title' => 'Reset Kata Laluan Admin',
    'system_name' => 'NEO V-TRACK - Sistem Pengurusan & Pemantauan Kenderaan',
    'reset_password' => 'Reset Kata Laluan Admin',
    'step1_title' => 'Langkah 1: Masukkan Emel Admin',
    ...
    'email_placeholder' => 'Masukkan emel admin',
...
$text['en'] = [
    ...
    'step1_title' => 'Step 1: Enter Admin Email',
    ...
    'back_to_login' => 'Back to Admin Login',
...
if (isset($_POST['step1'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        // Admin exists, proceed to step 2
        $step = 2;
        $user_email = $email;
...
<body>
    <div class="container">
        ...
        <div class="header-container">
            <div class="logo-row">
                <!-- UITM Logo -->
                <img src="/assets/images/uitm.png" alt="UITM Logo" class="logo-img uitm-logo"
                ...
                <!-- NEO V-TRACK Logo -->
                <img src="/assets/images/kik2.png" alt="NEO V-TRACK Logo" class="logo-img neo-logo"
