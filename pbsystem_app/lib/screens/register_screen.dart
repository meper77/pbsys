          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                Text('Join NEO V-TRACK to manage & monitor vehicles',
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      _field(controller: nameCtl, label: 'Full Name', icon: FontAwesomeIcons.user),
                      _field(controller: emailCtl, label: 'Email', icon: FontAwesomeIcons.envelope, keyboard: TextInputType.emailAddress),
                      _field(controller: pwCtl, label: 'Password', icon: FontAwesomeIcons.lock, obscure: true),
