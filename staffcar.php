...
// English
$text['en'] = [
    'page_title' => 'Staff Vehicle Management',
    'system_name' => 'NEO V-TRACK - Vehicle Management & Monitoring System',
    'admin_role' => 'Administrator',
    'logout' => 'Log Out',
    'logout_confirm' => 'Are you sure you want to log out?',
    'staff_vehicles_list' => 'Staff Vehicles List',
...
// Get staff vehicles data
$staff_vehicles = [];
$no = 1;
$sql = "SELECT * FROM `owner` WHERE status = 'Staf'";
    ...
    <div class="container">
        <div class="logo-container">
            ...
            <div class="system-title">
                <h1><i class="fas fa-user-tie"></i> <?php echo $t['page_title']; ?></h1>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="staffcar.php">
...
<div class="main-content">
    <div class="content-container">
        <div class="content-title">
            <span><i class="fas fa-list-alt me-2"></i><?php echo $t['staff_vehicles_list']; ?></span>
            <a href="addStaffcar.php" class="add-btn">
                <i class="fas fa-plus-circle me-2"></i><?php echo $t['add_staff_vehicle']; ?>
            </a>
        </div>
        ...
        <?php if (count($staff_vehicles) > 0): ?>
        <div class="table-responsive">
            <table class="data-table table-striped" id="staffTable">
                <thead>
                    <tr>
                        <th width="50"><?php echo $t['no']; ?></th>
                        <th width="120"><?php echo $t['staff_id']; ?></th>
                        <th><?php echo $t['staff_name']; ?></th>
                ...
                <tbody>
                    <?php 
                    $counter = 1;
                    foreach ($staff_vehicles as $row): 
                        $id = $row['id'];
                        $staffno = htmlspecialchars($row['idnumber']);
                        $staffname = htmlspecialchars($row['name']);
                        $phone = htmlspecialchars($row['phone']);
                        $staffplate = htmlspecialchars($row['platenum']);
                    ...
                    <tr>
                        ...
                        <td><strong><?php echo $staffname; ?></strong></td>
                        <td><?php echo $phone; ?></td>
                        <td><span class="vehicle-number"><?php echo $staffplate; ?></span></td>
                        <td><?php echo $type; ?></td>
                        <td>
                            <?php 
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="updateStaffcar.php?id=<?php echo $id; ?>" class="edit-btn">
                                    <i class="fas fa-edit me-1"></i><?php echo $t['edit']; ?>
                                </a>
                                <a href="deleteStaffcar.php?id=<?php echo $id; ?>" class="delete-btn" onclick="return confirm('<?php echo $lang == 'bm' ? 'Adakah anda pasti ingin memadam rekod ini?' : 'Are you sure you want to delete this record?'; ?>')">
        ...
        <div class="no-data">
            ...
            <h4><?php echo $lang == 'bm' ? 'Tiada Kenderaan Staf' : 'No Staff Vehicles'; ?></h4>
            <p><?php echo $lang == 'bm' ? 'Tiada rekod kenderaan staf dijumpai.' : 'No staff vehicle records found.'; ?></p>
            <a href="addStaffcar.php" class="btn btn-primary mt-3">
                <i class="fas fa-plus-circle me-2"></i><?php echo $t['add_staff_vehicle']; ?>
            </a>
        </div>
        <?php endif; ?>
...
$(document).ready(function() {
    ...
    $('#export-btn').on('click', function() {
        ...
        if (table.length) {
            ...
            var wb = XLSX.utils.table_to_book(tableClone[0], {sheet: "Staff Vehicles"});
            XLSX.writeFile(wb, "staff-vehicles-<?php echo date('Y-m-d'); ?>.xlsx");
        }
    });
});
</script>
